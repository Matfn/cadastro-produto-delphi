object frmPrincipal: TfrmPrincipal
  ...
  object queryProdutos: TADOQuery
    ...
    Left = 400
    Top = 16
    object queryProdutosCódProduto: TAutoIncField
      FieldName = 'C'#243'd. Produto'
      ReadOnly = True
    end
    object queryProdutosCódBarras: TStringField
      FieldName = 'C'#243'd. Barras'
      ReadOnly = True
      Size = 30
    end
    object queryProdutosDescrição: TStringField
    ...
    object queryProdutosQtdEstoque: TFloatField
